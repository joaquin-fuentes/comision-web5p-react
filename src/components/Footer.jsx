    ...
    <footer>
      <div className="container text-center">
        <div className="row">
          ...
          <div className="col order-2 links">
            <div className="container text-center">
              <div className="row">
                <div className="col-6 col-sm-4 fw-bold ">
                  <a href="#" className="text-danger">Incio</a>
                </div>
          ...
          <div className="col order-3 contacto">
            <div className="row">
                  ...
                  <div className="col">
                    <a href="#" onClick={() => hundleRedes("Facebook")}>
                      <img
                        ...
                        alt="Logo-Facebook" width="100" height="80"
                      />
                    </a>
                  </div>
                  <div className="col">
                    <a href="#" onClick={() => hundleRedes("Instagram")}>
                      <img
                        ...
                        alt="Logo-Instagram" width="100" height="80"
                      />
                    </a>
                  </div>
                  <div className="col">
                    <a href="#" onClick={() => hundleRedes("X")}>
                      <img
                        ...
                        alt="Logo-X" width="100" height="80"
                      />
                    </a>
                  </div>
                  <div className="col">
                    <a href="#" onClick={() => hundleRedes("Youtube")}>
                      <img
                        ...
                        alt="Logo-Youtube" width="100" height="80"
                      />
                    </a>
                  </div>
                </div>
